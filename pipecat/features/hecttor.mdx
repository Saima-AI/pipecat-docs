...
<Tip>
  Get your API key and download the SDK from the [Hecttor admin
  panel](https://admin.hecttor.ai).
</Tip>
...
The `hecttor_sdk` package is not published to PyPI, so install the wheel file you downloaded directly:
...
```bash
pip install hecttor_sdk-3.1.0-cp311-cp311-macosx_15_0_arm64.whl
```
